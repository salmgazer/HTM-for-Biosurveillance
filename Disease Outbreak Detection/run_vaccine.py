...
def runModel(model, inputFilePath, run_count):
    ...
    output = nupic_anomaly_output.NuPICFileOutput("Vaccination_present_fresh")
    ...
    com_file_name = "vaccination_accuracy_present_fresh.csv"
...
if __name__ == "__main__":
    inputFilePath = "vaccine_record_short.csv"
    for i in range(5):
        print "========================= ", i+1, " ============================"
