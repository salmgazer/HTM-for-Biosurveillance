...
'/home/salifu/.local/lib/python2.7/site-packages/nupic/swarming/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  'modelParams': {
    ...
    'sensorParams': {
      'encoders': {
          u'vaccine_date_timeOfDay': PermuteEncoder(fieldName='vaccine_date', encoderClass='DateEncoder.timeOfDay', radius=PermuteFloat(0.5, 12), w=21, ),
  u'vaccine_date_dayOfWeek': PermuteEncoder(encoderClass='DateEncoder.dayOfWeek', radius=PermuteFloat(1, 6), w=21, fieldName='vaccine_date', ),
  u'vaccine_date_weekend': PermuteEncoder(encoderClass='DateEncoder.weekend', radius=PermuteChoices([1]),  w=21, fieldName='vaccine_date', ),
  u'vaccine_name': PermuteEncoder(fieldName='vaccine_name', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='avg_err':steps=\[1\]:window=1000:field=vaccine_name")
minimize = "multiStepBestPredictions:multiStep:errorMetric='avg_err':steps=\[1\]:window=1000:field=vaccine_name"
